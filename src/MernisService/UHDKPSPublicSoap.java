...
public class UHDKPSPublicSoap
{
    ...
    public UHDKPSPublicSoap(){}

    public UHDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public UHDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        UHDExtendedSoapSerializationEnvelope envelope= new UHDExtendedSoapSerializationEnvelope(UHDExtendedSoapSerializationEnvelope.VER11);
