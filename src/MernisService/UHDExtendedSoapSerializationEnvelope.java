...
public class UHDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(UHDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new UHDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static UHDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static UHDDateTimeConverter dateTimeConverter = new UHDStandardDateTimeConverter();

    public UHDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public UHDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new UHDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=UHDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,UHDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=UHDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
